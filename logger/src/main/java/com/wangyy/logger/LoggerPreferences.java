...
public class LoggerPreferences {
     ...
     * 默认自动清理天数.
     */
    private static final int DEFAULT_CLEAR_DAYS = 15;
     ...
     * 设置Crash界面退出密码.
     */
    public void setCrashExitPassword(String password) {
        sp.edit().putString(CRASH_EXIT_PASSWORD, password).apply();
    }

    /**
     * 获取Crash界面退出密码.
     */
    public String getCrashExitPassword() {
        return sp.getString(CRASH_EXIT_PASSWORD, "159357");
    }
}
